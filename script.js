...
(function injectBuiltByBadge() {
  ...
  Object.assign(badge.style, {
    ...
    zIndex:               '9999',
    cursor:               'pointer', // Cursor change kiya
    userSelect:           'auto',    // Selection enable kiya
    opacity:              '0',
    transform:            'translateY(10px)',
    transition:           'opacity 0.5s ease, transform 0.5s ease',
  });

  // CLICK KARNE PAR MAIL KHULNE KA LOGIC
  badge.addEventListener('click', () => {
    window.location.href = "mailto:harshvardhanlokhande762@gmail.com?subject=Inquiry%20from%20Portfolio";
  });
